...
export default class CollarPage extends BasePage {
  readonly collar_searchInput = this.page.locator("//input[@placeholder='Tìm kiếm cổ áo...']")
  ...
  async open() {
    await super.open('/admin/attribute/collar');
  }
